"""
Django settings for tahani project.

SPK Fuzzy Database Model Tahani
Sistem Pendukung Keputusan Pemilihan Penerima Bantuan Sosial
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-)_dglf9%*^ddtz=g$l!rr_7g8go)7#!)#^d-_p$a^sxab18qm(')
...
# CSRF Trusted Origins untuk Railway/Render
...
WSGI_APPLICATION = 'tahani.wsgi.application'
